---
title: "Why do Sigaporeans buy cars?"
...
try(setwd("/Users/emiliasicari/Desktop/Final_assignment/Final.presentation/"))
try(setwd("/Users/rafalopezv/Dropbox/R/Final_assignment/Final.presentation/"))
...
try(source("/Users/rafalopezv/Dropbox/R/Final_assignment/Preliminary.presentation/Figures.R"))
...
<small>**$$Cars_{t} = {\beta}_1 + {\beta}_2 Cars_{t-1} + {\beta}_3 GDPpc_{t} + {\beta}_4 GDPpc_{t-1} + {\beta}_5 top.10.inc_{t-1} + {\beta}_6 bottom.90.inc_{t-1} + {\beta}_7 Bus.usage_{t} + {\beta}_8 MRT.usage_{t} + {\beta}_9 LRT.usage_{t}$$**</small>
