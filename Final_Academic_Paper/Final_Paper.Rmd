...
bibliography: 
  - bibliography.bib
  - /Users/rafalopezv/Dropbox/R/Final_assignment/packages.bib
---
...
packages <- c('devtools', 'repmis', 'Quandl', 'data.table', 'rio', 'ggplot2', 'stargazer', 'pander', 'corrplot', 'dplyr', 'magrittr', 'knitr', 'scales')
...
On the "rational side" we asses the influence of income, GDP and usage of public transport on the purchase of cars, whereas inequality and the presence of cars (as a status symbol) are the explanatory variables on the behavioural turf. Consequently, we built three different models and eventually chose one. The data cover a time span of 19 years (from 1995 until 2015), and were mainly gathered directly from open sources, transformed and presented in an readable way.  
