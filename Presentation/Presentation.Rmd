...
- The model matches almost all the hypotheses, however, its explanatory power il limited:
    ...
    + more population quartiles in terms of income would be useful to know which segment of the population is affecting more purchase of cars and its relation woth the social status.
